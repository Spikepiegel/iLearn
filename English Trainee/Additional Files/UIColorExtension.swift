...
extension UIColor {
    ...
    static var whiteGradientColor: UIColor {
        #colorLiteral(red: 0.9228700139, green: 0.9095009464, blue: 1, alpha: 1)
    }
    
    static var cyanGradientColor: UIColor {
        #colorLiteral(red: 0.6288508155, green: 0.9999031825, blue: 1, alpha: 1)
    }
